export function Moveit(el, options) {
  this.el = el;
  ...
  if (this.el.nodeName) {
      ...
      if (tagName === 'path') {
        ...
        var points = this.el.getAttribute('points');
              points = points.split(" ");
          var x1 = null, x2, y1 = null, y2, x3, y3;
          d = 0;
          ...
          var elx1 = this.el.getAttribute('x1');
          var elx2 = this.el.getAttribute('x2');
          var ely1 = this.el.getAttribute('y1');
          var ely2 = this.el.getAttribute('y2');
          d = Math.sqrt(Math.pow((elx2 - elx1), 2) + Math.pow((ely2 - ely1), 2));
      }
      return d;
  }
}
